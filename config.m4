...
if test "$PHP_PHONETIC" != "no"; then
  ...
  dnl Beider-Morse and Daitch-Mokotoff rule tables (vendored from Apache Commons
  dnl Codec, Apache-2.0) are compiled in via the generated src/bmpm_data.h and
  dnl src/dm_data.h, so there is no external library dependency.
