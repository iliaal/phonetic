...
{
	REGISTER_LONG_CONSTANT("BMPM_GENERIC", 0, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BMPM_ASHKENAZI", 1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BMPM_SEPHARDIC", 2, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BMPM_APPROX", 1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BMPM_EXACT", 2, CONST_CS | CONST_PERSISTENT);
	return SUCCESS;
}
